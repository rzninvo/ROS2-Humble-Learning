...
class PerceptionNode : public rclcpp::Node
{
    public:
                                          ...
                                          .automatically_declare_parameters_from_overrides(true))
        {
            ...
            plane_publisher_removed_ = 
                this->create_publisher<sensor_msgs::msg::PointCloud2>("plane_cluster_removed", 1);
            euclidean_publisher_ = 
                this->create_publisher<sensor_msgs::msg::PointCloud2>("euclidean_cluster", 1);
            cropbox_publisher_ = 
                this->create_publisher<sensor_msgs::msg::PointCloud2>("cropbox_cluster", 1);
            stat_publisher_ = 
    ...
    private:
        ...
        void cloud_callback(const sensor_msgs::msg::PointCloud2::ConstSharedPtr recent_cloud)
        {
            ...
            pcl::PointCloud<pcl::PointXYZ> xyz_filtered_cloud_cropbox;
            ...
            crop.filter(xyz_filtered_cloud_cropbox);
            pcl::PointCloud<pcl::PointXYZ>::Ptr cropped_cloud_cropbox(new pcl::PointCloud<pcl::PointXYZ>(xyz_filtered_cloud_cropbox));
            ...
            *cloud_filtered = *cloud_f;
            ...
            this->publishPointCloud(plane_publisher_, *cloud_plane);
            this->publishPointCloud(plane_publisher_removed_, *cloud_f);
            this->publishPointCloud(euclidean_publisher_, *clusters.at(0));
            this->publishPointCloud(cropbox_publisher_, xyz_filtered_cloud_cropbox);
        ...
        rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr plane_publisher_removed_;
